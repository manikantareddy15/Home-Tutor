        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-6 sm:p-8">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className={`flex-1 px-4 py-3 border-2 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-blue-500 ${editingFields.fullName
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className={`flex-1 px-4 py-3 border-2 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-blue-500 ${editingFields.email
                          ? "border-blue-400 bg-white"
                          : "border-gray-300 bg-gray-50 cursor-not-allowed"
                        }`}
                    />
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      ...
                      className={`flex-1 px-4 py-3 border-2 rounded-lg transition focus:outline-none focus:ring-2 focus:ring-blue-500 ${editingFields.password
                          ? "border-blue-400 bg-white"
                          : "border-gray-300 bg-gray-50 cursor-not-allowed"
                        }`}
                    />
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 flex gap-3">
            <button
              ...
              className={`flex-1 px-6 py-3 border-2 border-gray-300 text-gray-700 font-bold rounded-lg transition ${isAnyFieldEditing
            ...
            <button
              ...
              className={`flex-1 px-6 py-3 bg-blue-600 text-white font-bold rounded-lg transition flex items-center justify-center gap-2 ${!loading && isAnyFieldEditing
